...
credential store can be used on all OSes. E.g.
...
are portable. Calling a function on the wrong OS will throw an
...
adds or updates a credential in the credential store. It takes objects
created with
[`windows_item()`](https://r-lib.github.io/oskeyring/dev/reference/windows_credentials.md)
:
...
reads a credential from the credential store, the return value includes
the secret as well:
...
lists all credentials that match a prefix.

[`windows_item_delete()`](https://r-lib.github.io/oskeyring/dev/reference/windows_credentials.md)
deletes a credential.

See more in the manual:
[`?windows_credentials`](https://r-lib.github.io/oskeyring/dev/reference/windows_credentials.md).
...
adds a new item to a keychain. It takes objects created with
[`macos_item()`](https://r-lib.github.io/oskeyring/dev/reference/macos_keychain.md):
...
on the item class. See
[`?macos_keychain`](https://r-lib.github.io/oskeyring/dev/reference/macos_keychain.md)
for the list of attributes for each class.
...
updates the attributes of existing Keychain items.

[`macos_item_delete()`](https://r-lib.github.io/oskeyring/dev/reference/macos_keychain.md)
deletes one or more Keychain items.
